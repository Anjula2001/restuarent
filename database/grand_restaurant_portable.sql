-- Grand Restaurant Database Export
-- Generated: 2025-06-08
-- Source: SQLite Database converted for MySQL/MariaDB compatibility
-- Description: Complete database structure and data for Grand Restaurant Management System

-- Note: This file is compatible with both SQLite and MySQL/MariaDB
...
INSERT OR IGNORE INTO menu_items VALUES(70,'Sri Lankan String Hoppers','Traditional Sri Lankan breakfast made from rice flour, served with coconut sambol and curry',450,'Traditional','images/popular/1.png',1,'2025-06-08 07:10:07','2025-06-08 07:10:07');
INSERT OR IGNORE INTO menu_items VALUES(71,'Seafood Fried Rice','Fragrant rice with prawns, calamari, and crab meat',750,'Rice & Curry','images/popular/3.png',1,'2025-06-08 07:10:07','2025-06-08 07:10:07');
INSERT OR IGNORE INTO menu_items VALUES(72,'Mutton Biryani','Aromatic basmati rice cooked with tender mutton and traditional spices',850,'Rice & Curry','images/popular/2.png',1,'2025-06-08 07:10:07','2025-06-08 07:10:07');
INSERT OR IGNORE INTO menu_items VALUES(73,'Fish Kottu','Traditional kottu roti with fresh fish, vegetables, and aromatic spices',650,'Kottu','images/popular/1.png',1,'2025-06-08 07:10:07','2025-06-08 07:10:07');
INSERT OR IGNORE INTO menu_items VALUES(74,'General Tso Chicken','Crispy chicken pieces in sweet and spicy sauce',720,'Chinese','images/popular/2.png',1,'2025-06-08 07:10:07','2025-06-08 07:10:07');
...
INSERT OR IGNORE INTO reviews VALUES(23,'John Smith','john@email.com',5,'Amazing food and great service! The ribeye steak was perfectly cooked.',1,'2025-06-08 07:10:07');
INSERT OR IGNORE INTO reviews VALUES(24,'Sarah Johnson','sarah@email.com',4,'Loved the atmosphere and the salmon was delicious. Will definitely come back!',1,'2025-06-08 07:10:07');
INSERT OR IGNORE INTO reviews VALUES(25,'Mike Wilson','mike@email.com',5,'Best pizza in town! The margherita was authentic and fresh.',1,'2025-06-08 07:10:07');
INSERT OR IGNORE INTO reviews VALUES(26,'Emily Davis','emily@email.com',5,'Great restaurant for special occasions. The lobster ravioli was outstanding.',1,'2025-06-08 07:10:07');
...
INSERT OR IGNORE INTO initialization_marker VALUES('2025-06-08 07:10:07');

SET foreign_key_checks = 1;

-- Database conversion complete
-- Total records: 13 menu items, 1 order, 1 order item, 10 reviews, 1 admin user, 6 users
