-- Grand Restaurant Unified Database
-- Generated: June 8, 2025
-- Description: Complete unified database structure and data for Grand Restaurant Management System
-- Compatible with SQLite, MySQL, and MariaDB
-- 
-- This file combines all database schemas, structures, and data from multiple SQL files
-- into a single comprehensive database backup.
--
-- Usage Instructions:
-- For SQLite: sqlite3 database/grand_restaurant.db < database/grand_restaurant_unified.sql
-- For MySQL: mysql -u username -p database_name < database/grand_restaurant_unified.sql
-- Or use the restore script: php restore_database.php
--
-- Cross-Platform Compatibility:
-- - SQLite: Use as-is
-- - MySQL/MariaDB: Replace AUTOINCREMENT with AUTO_INCREMENT where needed
...
-- End of Grand Restaurant Unified Database
...
-- File consolidates: complete_database.sql, grand_restaurant_complete.sql, grand_restaurant_export.sql, 
